...
//Copy on select
const copyOnSelectSetter = document.getElementById('clean_on_click_setter')
const copyOnSelectSwitch = document.getElementById('clean_on_click_switch')
const copyOnSelectonOffIndicator = document.getElementById('clean_on_click_on_off_label')
